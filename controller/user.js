let {registerpatient,loginpatient,addprofile,updateProfile,getme,forget,reset,change,updateprofile,deactivate,assignpermission, findall,update,getpermission,getpermission2,softdelete,softundelete,unactive, active}=require("../model/user")
...
module.exports= {register,login,my_profile_pic,update_profile_pic,forgetpassword,about_me,resetpassword,changepassword,updatemyprofile,deactivateme,addpermission,finduser,updateuser,permission,userpermission, softdeleteuser,softundeleteuser,activeuser,unactiveuser, exporUsert}